...
15. Historical research about authenticated Microsoft metadata APIs may remain only in `docs/architecture-insight.md` or `docs/source-learnings.md` when explicitly marked out of scope, not active architecture instructions.

...
- Project identity is `win11_release_guard` for the repository, distribution metadata, console command, cache path, user agent, WUA `ClientApplicationID`, and Python import package.
